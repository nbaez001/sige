...
public class TiempoPromedioAtencionTramitePorOficina extends CustomComponent
	...
	public TiempoPromedioAtencionTramitePorOficina(Window quienLlama,
			Permiso permiso) {
	...
	private void visualizarReporte() {
		...
		StreamResource resource = new StreamResource(
					...
					public InputStream getStream() {
						...
						try {
							DocContent = reporteServicio.obtenerReporte(
									"TiempoPromedioAtencionTramitePorOficina",
				...
				}, "TiempoPromedioAtencionTramitePorOficina.pdf");
		this.embReporte.setSource(resource);
		resource.setMIMEType("application/pdf");
		resource.getStream()
				.setParameter("Content-Disposition",
						"attachment; filename=TiempoPromedioAtencionTramitePorOficina.pdf");
	...
	private AbsoluteLayout buildMainLayout() {
		...
		btnVisualizar.setWidth("129px");
		btnVisualizar.setHeight("-1px");
		mainLayout.addComponent(btnVisualizar, "top:10.0px;left:552.0px;");

		// embReporte
		embReporte = new Embedded();
		embReporte.setImmediate(false);
		embReporte.setWidth("670px");
		...
		mainLayout.addComponent(embReporte, "top:40.0px;left:10.0px;");
